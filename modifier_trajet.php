...
<body>
    ...
    <div class="container">
        <div class="form-container">
            ...
            <form action="update_trajet.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="nombre_places_total" name="nombre_places_total" 
                        value="<?php echo $trajet['nombre_places_total']; ?>" min="1" max="8" required>
                </div>
                
                <button type="submit" class="btn-submit">Modifier le trajet</button>
            </form>
        </div>
    </div>
